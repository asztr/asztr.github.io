...
vec3.normal = function(vec1, vec2) {
	var dest = vec3.create();

	dest = vec3.normalize(vec3.cross(vec1, vec2));
}
 ...
 */
vec3.direction = function(vec, vec2) {
	var dest = vec3.create();
 ...
 *
 * Params:
 * mat - mat3, first operand
 * mat2 - mat3, second operand
 * dest - Optional, mat3 receiving operation result. If not specified result is written to mat
 *
 * Returns:
 ...
 *
 * Params:
 * mat - mat3 to translate
 * vec - vec2 specifying the translation
 * dest - Optional, mat3 receiving operation result. If not specified result is written to mat
 *
 * Returns:
 * dest if specified, mat otherwise
...
mat3.translate = function(mat, vec, dest) {
	...
	dest[6] = a00*x + a10*y + a20*z + mat[6];
	dest[7] = a01*x + a11*y + a21*z + mat[7];
	dest[8] = a02*x + a12*y + a22*z + mat[8];
	return dest;
};
